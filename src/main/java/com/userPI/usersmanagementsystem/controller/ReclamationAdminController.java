...
public class ReclamationAdminController {
    ...
    @GetMapping("/types")
    public ResponseEntity<Map<String, Long>> getReclamationsByType() {
        return ResponseEntity.ok(reclamationService.getCountByType());
    }

    @GetMapping("/status")
    public ResponseEntity<Map<String, Long>> getReclamationsByStatus() {
        return ResponseEntity.ok(reclamationService.getCountByStatus());
    }

    @GetMapping("/monthly")
    public ResponseEntity<Map<String, Long>> getReclamationsByMonth() {
        return ResponseEntity.ok(reclamationService.getCountByMonth());
    }
}