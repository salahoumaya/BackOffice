...
import com.userPI.usersmanagementsystem.dto.*;
...
import com.userPI.usersmanagementsystem.repository.ExamenParticipantRepository;
...
public class TrainingService implements ITrainingService {
    ...
    public List<UserMoyenneResponse> getUsersWithMoyenne(Long formationId) {
        ...
        for (UserNoteDTO dto : results) {
            OurUsers user = userRepository.findById(dto.getUserId()).orElse(null);
            if (user != null) {
