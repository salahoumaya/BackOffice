...
import com.userPI.usersmanagementsystem.entity.user.UserStatus;
...
public class UsersManagementService {
    ...
    public ReqRes register(ReqRes registrationRequest) {
        ...
        System.out.println("📥 Données reçues: " + registrationRequest); // Debug log
        return resp;
    }
    ...
    public ReqRes login(ReqRes loginRequest) {
        ...
        try {
            ...
            if (userOptional.isEmpty()) {
                ...
                response.setMessage("Email non trouvé.");
                return response;
            }
            ...
            if (!passwordEncoder.matches(loginRequest.getPassword(), user.getPassword())) {
                response.setStatusCode(401);  // Mot de passe incorrect
            ...
            if (user.getStatus() == UserStatus.PENDING) {
                ...
                response.setMessage("Votre compte est en attente d'approbation.");
                return response;
            } else if (user.getStatus() == UserStatus.REJECTED) {
                response.setStatusCode(403);
                response.setMessage("Votre compte a été rejeté.");
                return response;
            }

            // 🔹 Authentification (si tout est bon)
