package tn.esprit.tacheevaluation.config;
...
import tn.esprit.tacheevaluation.config.JWTAuthFilter;
import tn.esprit.tacheevaluation.entity.UserRole;
import tn.esprit.tacheevaluation.service.OurUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/auth/**", "/public/**","/diplomes/users/Image/**").permitAll()
